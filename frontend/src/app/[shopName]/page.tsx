...
const ShopPage = () => {
  ...
  // Handle error/not found state separately if needed, or rely on SkeletonLayer to just block until done.
  // We can keep the "Shop Not Found" check outside the SkeletonLayer if we want it to render only after loading is false.
    ...
    <ProtectedRoute requireAuth={false}>
      <div className="flex min-h-screen flex-col bg-background">
        ...
        <main className="flex-1 pb-12">
            <SkeletonLayer isLoading={loading} fallback={<ShopDetailsSkeleton />}>
            {shop && (
                <>
