...
const Navbar: React.FC<NavbarProps> = ({ name }) => {
  ...
  return (
    <div className="lg:px-10 px-4 py-3 flex justify-center items-center lg:gap-10 gap-5">
      ...
      <div className=" flex border-2 p-1 px-3 rounded-lg items-center">
        <Input
          type="text"
          placeholder="search"
          className=" w-[60vw] lg:w-[50vw] text-xs lg:text-md border-none"
        />
        <Button size="lg" className="w-[50px] bg-green-700">
          <Search size={40}/>
        </Button>
      </div>
      <DropdownMenu>
