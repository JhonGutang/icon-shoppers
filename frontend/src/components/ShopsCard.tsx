...
const ShopsCard: React.FC<ShopsProps> = ({ shop }) => {
  ...
  return (
    <Card className="lg:w-[25vw] lg:h-[40vh] h-[37vh] w-[45vw] px-0 pt-0 transition-transform duration-300 hover:scale-105">
      <CardContent className="px-0">
        <img
          ...
          alt=""
          className="rounded-t-xl lg:h-[30vh] h-[22vh] w-full"
        />
        <div className="p-3 lg:flex justify-between">
          <div className="text-lg">{shop.name}</div>
          <Button className="px-10 bg-green-700 mt-2" onClick={() => redirectLink(shop.name)}>
            View Shop
          </Button>
        </div>
